...
public class Test {
	...
	/*
	 * 	String => 이 메소드를 호출한 그 위치로 String type 참조값을 되돌려주는 메소드
	 */
	...
	// Airplane type 을 메소드의 인자로 전달 받는 메소드 AirPlane plane = new AirPlane <- 참조값 얻어내기
	public void setPlane(AirPlane plane) {
		
	}
	
	//	int type, String type, Airplane type 3개를 전달 받는 메소드
